...
const PostJob = () => {
    ...
    const submitHandler = async (e) => {
        ...
        if (!input.title || !input.description || !input.location || !input.startDate || !input.endDate) {
            toast.error("Please fill in all required fields including start & end date");
            return;
        }
    
        // 🔍 Log for debugging
        console.log("🚀 Job payload being sent:", input);
