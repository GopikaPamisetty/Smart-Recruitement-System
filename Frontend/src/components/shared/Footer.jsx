      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex justify-center space-x-6">
            <a href="https://facebook.com" className="text-gray-600 hover:text-[#4267B2] transition" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="text-gray-600 hover:text-[#1DA1F2] transition" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="text-gray-600 hover:text-[#0077B5] transition" aria-label="LinkedIn">
